...
export default function DockIcon({ bgColor, name, iconSize }) {
   ...
   return (
      <Link to={path}>
         <div className="cursor-pointer transition-all ease-linear transform-gpu hover:scale-110 ease-in">
            <div
               className={`flex p-4 ring-1 ring-black ring-opacity-5 shadow-lg text-white items-center justify-center ${bgColor ||
