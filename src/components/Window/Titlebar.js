...
export default function Titlebar({ title }) {
    return (
        <div className="relative flex flex-row items-center w-full p-3 text-white bg-gray-800 cursor-pointer ring-1 ring-black ring-opacity-5 drag-handle justify-items-center rounded-t-xl">
